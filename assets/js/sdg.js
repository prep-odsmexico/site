...
var mapView = function () {
  ...
  this.initialise = function(indicatorId, precision, precisionItems, decimalSeparator, dataSchema, viewHelpers, modelHelpers, chartTitles, startValues) {
    ...
    $('#map').sdgMap({
      ...
      mapLayers: [{"subfolder":"map/entidades-federativas","label":"indicator.map","min_zoom":7,"max_zoom":20,"staticBorders":true},{"subfolder":"map/municipios","label":"indicator.map","min_zoom":0,"max_zoom":6,"staticBorders":false}],
      precision: precision,
